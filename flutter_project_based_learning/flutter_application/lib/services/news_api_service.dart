...
class NewsApiService {
  ...
  Future<List<NewsArticle>> fetchTopHeadlines({
    ...
    final uri = Uri.parse(
      '$_baseUrl/top-headlines?country=us&category=$category&page=$page&pageSize=$pageSize&apiKey=${ApiKeys.newsApi}',
    );
  ...
  Future<List<NewsArticle>> searchArticles({
    ...
    final uri = Uri.parse(
      '$_baseUrl/everything?q=$query&page=$page&pageSize=$pageSize&apiKey=${ApiKeys.newsApi}',
    );
    final response = await http.get(uri);
